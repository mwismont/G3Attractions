...
package com.example.g3.provider;
...
public class TouristAttractions
{
    ...
    public static void initAttractions(android.content.res.Resources resources)
    {
        ATTRACTIONS.put(CITY_SYDNEY, new ArrayList<Attraction>() {{
                add(new Attraction(
                        1,
                        resources.getString(R.string.attraction_opera_house),
                        ...
                        Uri.parse("https://goo.gl/maps/xUsLNhabjRjsEyyR6"),
                ...
                add(new Attraction(
                        2,
                        resources.getString(R.string.attraction_harbour_bridge),
                        ...
                        Uri.parse("https://goo.gl/maps/Smn8J1LVNQ8JiNyQA"),
                ...
                add(new Attraction(
                        3,
                        resources.getString(R.string.attraction_darling_harbour),
                        ...
                        Uri.parse("https://goo.gl/maps/89xBc6tVndGoQ57Z8"),
                ...
                add(new Attraction(
                        4,
                        resources.getString(R.string.attraction_bondi_beach),
                        ...
                        Uri.parse("https://goo.gl/maps/3MmB1eK3AbS3NHoP9"),
                ...
                add(new Attraction(
                        5,
                        resources.getString(R.string.attraction_taronga_zoo),
                        ...
                        Uri.parse("https://goo.gl/maps/yDAuv5mLoAZwDCDbA"),
